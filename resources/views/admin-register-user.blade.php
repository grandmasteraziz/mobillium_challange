    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.user.register.submit') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="first_name" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tckn" type="text" class="form-control{{ $errors->has('tckn') ? ' is-invalid' : '' }}" name="tckn" value="{{ old('tckn') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birthyear" type="text" class="form-control{{ $errors->has('birthyear') ? ' is-invalid' : '' }}" name="birthyear" value="{{ old('birthyear') }}" required autofocus>
